...
function relatedViewResultRequest(s: RematchStore, queryCreator: QueryCreator, mainQuery: Query) {
  ...
  return s.dispatch.result.requestAsync({resultType: queryCreator.type, query, filterKey: mainQueryKey});
}
